 ...
 * 
 */
public class LockedOutUsersCustomerBatchReportBatchWriter extends LockedOutUsersReportBatchWriter implements
        ItemWriter<Customer> {

    private static Logger logger = LoggerFactory.getLogger(LockedOutUsersCustomerBatchReportBatchWriter.class);
     ...
     */
    public LockedOutUsersCustomerBatchReportBatchWriter(String outputFileName, String timeStamp, String iisn)
            throws IOException {
    ...
    public void write(List<? extends Customer> items) throws Exception {
        ...
        for (Customer customer : items) {
            lines.add(processLoginHistoryRequest(customer));
            ++super.value;
        }
     ...
     * @return
     */
    protected String processLoginHistoryRequest(Customer customer) {
        return getContentToWrite(customer);
    }
     ...
     * @param loginHistory
     */
    protected String getContentToWrite(Customer customer) {
