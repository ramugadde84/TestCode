...
CREATE TABLE REPORT_HISTORY(ID INTEGER NOT NULL AUTO_INCREMENT,
                            REPORT_TYPE VARCHAR(30),
                            LAST_REPORT_TIME TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00',
                            KEY IDX_REPORT_HISTORY_TYPE(REPORT_TYPE),
                            KEY IDX_REPORT_HISTORY_ID(ID));
